...
checkLevel(1, 1, 1, 9, 9, 9, 9, 9, 9);
	...
	$attendance = mysqli_query($con, "SELECT *, (SELECT COUNT(student_id) FROM student_attendance WHERE student_id = student.student_id AND EXTRACT(YEAR FROM absent_date)=$year AND EXTRACT(MONTH FROM absent_date)=$month) AS total_absent FROM student");
	$row_attendance = mysqli_fetch_assoc($attendance);
?>
<?php require_once("top.php"); ?>

<a href="student_attendance_add.php" class="pull-left btn btn-primary">
	<span class="glyphicon glyphicon-plus-sign"></span>
	ثبت غیرحاضری شاگرد
</a>

<h2>گزارش حاضری شاگردان</h2>
...
<table class="table table-striped">
	...
	<tr>
		...
		<td>
			<a href="student_attendance_detail.php?student_id=<?php echo $row_attendance["student_id"]; ?>&absent_year=<?php echo $year; ?>&absent_month=<?php echo $month; ?>">
